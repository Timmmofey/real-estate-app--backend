namespace Classified.Shared.Constants
{
    ...
    {
        public const string Auth = "classified-auth-token";
        public const string Refresh = "classified-refresh-token";
        public const string Device = "classified-device-id-token";
        public const string Restore = "classified-restore-token";
